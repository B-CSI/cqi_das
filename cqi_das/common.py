...
start_of_sea_channel_SAFE = (
    236  # (or 239 -> 233??) #Turns out all Aragon Photonics interrogators start at meter 60
)

# Hoping all these are still correct...
candas2_limits = {"first_ch": 415, "first_time": 3000, "last_time": 6000}
safe2_limits = {"first_ch": 236, "first_time": 5000, "last_time": 7500}
safe_limits = {"first_ch": 236, "first_time": 3000, "last_time": 6500}
castor2_limits = {"first_ch": 1082, "first_time": 2500, "last_time": 4000}
twin_gc_limits = {"first_ch": 415, "last_time": 3000}
twin_tf_limits = {"first_ch": 745, "first_time": 4000, "last_time": 6000}
tf_2nd_pick_limits = {"first_ch": 745, "first_time": 4000}
tf_same_day_limits = {"first_ch": 745, "first_time": 4500, "last_time": 7500}
castor_limits = {"first_ch": 1082, "first_time": 1800, "last_time": 2800}
candas1_limits = {"first_ch": 415, "first_time": 13000, "last_time": 18000}
...
bad_channels_candas2 = np.loadtxt(
    "channel_selections/quality_picks_candas2_picked_0730_1940.csv", delimiter=",", skiprows=1
)
...
bad_channels_twin_gc = np.loadtxt(
    "channel_selections/quality_picks_gc_twin_event_G20200822_1713_picked_0802_1839.csv",
    delimiter=",",
    skiprows=1,
)
...
bad_channels_twin_tf = np.loadtxt(
    "channel_selections/quality_picks_tf_twin_event_T20200822_1713_picked_0807_0337.csv",
    delimiter=",",
    skiprows=1,
)
...
bad_channels_castor = np.loadtxt(
    "channel_selections/quality_picks_castor2_20230720_picked_0813_2235.csv",
    delimiter=",",
    skiprows=1,
)
